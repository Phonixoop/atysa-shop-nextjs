...
export default function FAQPage({ data }) {
  ...
  return (
    <div class="w-full p-5 bg-light-blue" dir="rtl">
      <div class="flex justify-center items-start my-2">
        <div class="w-full sm:w-10/12 md:w-1/2 my-1">
          <h2 class="text-xl font-semibold text-vnet-blue mb-2">
            سوالات متداول
          </h2>
          <ul class="flex flex-col" dir="rtl">
...
function LI({ isOpen, title, content, onChange = () => {} }) {
  ...
  return (
    <li class="bg-white my-2 shadow-lg rounded-xl overflow-hidden">
      <h2
      ...
      >
        <span>{title}</span>
        <svg
          class="fill-current text-atysa-main h-6 w-6 transform transition-transform duration-500"
          viewBox="0 0 20 20"
        >
      ...
      <div
        ref={liRef}
        class={`border-r-2 border-atysa-main overflow-hidden  ${
          isOpen ? heightClass : "h-0"
        } duration-500 transition-all`}
      >
        <p class="p-3 text-gray-900">{content}</p>
      </div>
    </li>
  );
}
