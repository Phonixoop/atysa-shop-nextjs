...
export default function ProfileLayout({ children }) {
  ...
  return (
    <div
      dir="rtl"
      className="flex mobileMin:flex-row flex-col gap-10 justify-center mobileMin:items-start  items-center w-8/12 mx-auto py-10"
    >
...
function FantasyMenu() {
  ...
  return (
    <ul
      ref={navElement}
      className="relative flex flex-col place-center gap-1 w-52 text-center bg-[#F3F3F4] rounded-lg p-1"
    >
      {menu.map((item) => {
        return (
